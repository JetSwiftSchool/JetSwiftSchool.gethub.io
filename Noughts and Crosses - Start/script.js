var currentPlayer = 1; //current player 1 / 2
var plays= 0  // counts amount of plays have happened

var board = document.querySelector("#board"); // points to the board

//checks what box is clicked
